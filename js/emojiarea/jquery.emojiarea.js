...
(function($, window, document) {
  ...
  var EmojiArea_Plain = function($textarea, id, options) {
    ...
    EmojiArea_Plain.prototype.updateBodyPadding = function() {
      // no-op
    };
  ...
  EmojiArea_Plain.prototype.insert = function(emoji) {
    if (!$.emojiarea.icons.hasOwnProperty(emoji))
      return;
    var unicodeEmoji = this.emojiPopup.colonToUnicode(emoji);
    util.insertAtCursor(unicodeEmoji, this.$textarea[0]);
    /*
     * MODIFICATION: Following line was added by Igor Zhukov, in order to
     * save recent emojis
     */
    util.emojiInserted(unicodeEmoji, this.menu);
  ...
  EmojiArea_WYSIWYG.prototype.val = function() {
    ...
    var sanitizeNode = function(node) {
      if (node.nodeType === TEXT_NODE) {
        ...
        /*
         * ! MODIFICATION START Following modification was added by Nikolay Bukin
         * It removes <style> tags from content due to <style> innerText is implicitly added to text "model".
         */
        if (tagName === 'style')
          return;
        /* ! MODIFICATION END */
  ...
  EmojiMenu.prototype.reposition = function() {
    if (!this.tether) {
      ...
      this.tether = new Tether({
        ...
        target: '[data-id="' + this.id + '"][data-type="input"]',
