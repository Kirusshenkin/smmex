    ...
    <div class="section_overlay">
        ...
        <div class="container home-container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <a class="btn btn-primary submit-btn" href="/register.php" style="float: right;width: auto">Зарегистрироваться</a>
                    <span class="header-question">Впервые у нас?</span>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="home_text">
                        <h1 class="text-center"><span>Рады</span> видеть вас снова!</h1>
                        <div class="contact_form">
                            <form onsubmit="login(event, this)">
                                <div class="form-group">
                                    <input type="text" id="username" class="form-control" name="username" placeholder="Логин или E-mail">
                                </div>
                                <div class="form-group">
                                    <input type="password" id="password" class="form-control" name="password" placeholder="Пароль">
                                </div>
                                <div class="form-group">
                                    <button class="btn btn-action btn-block">Войти</button>
                                </div>
